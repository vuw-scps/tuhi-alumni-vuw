...
// #place(top+left, dx:logo-position.at(0), dy:logo-position.at(1), box(width:2*logo-radius, height:2*logo-radius, clip: true, radius: logo-radius)[#image("images/kiri.png", height: 2*logo-radius)])

// #place(top+left, dx:logo-position.at(0), dy:logo-position.at(1), circle(stroke: white + line-width,radius: logo-radius))

// #place(top+left, dx:name-position.at(0), dy:name-position.at(1), text(size:24pt, weight: "bold")[Kiri van Koughnet])
// #place(top+left, dx:name-position.at(0), dy:name-position.at(1)+12mm, text(size:22pt)[BSc (Hons) in Physics])

// #set text(fill: white)
// #set par(leading: 12pt)
// #place(top+left, dx:title-position.at(0), dy:title-position.at(1), {
//   smallcaps(lower(text(size:26pt, weight: "bold", tracking: 1.5pt)[PhD candidate]))
//   v(0.8em,weak: true)
// text(size:22pt)[Rare-earth nitrides spintronics]
// }
// )
