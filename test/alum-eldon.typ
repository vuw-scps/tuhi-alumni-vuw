...
// #place(top+left, dx:logo-position.at(0), dy:logo-position.at(1), box(width:2*logo-radius, height:2*logo-radius, clip: true, radius: logo-radius)[#image("images/eldon.png", height: 2*logo-radius)])

// #place(top+left, dx:logo-position.at(0), dy:logo-position.at(1), circle(stroke: white + line-width,radius: logo-radius))

// #place(top+left, dx:name-position.at(0), dy:name-position.at(1), text(size:24pt, weight: "bold")[Eldon Tate])
// #place(top+left, dx:name-position.at(0), dy:name-position.at(1)+12mm, text(size:22pt)[PhD in Chemistry ])

// #set text(fill: white)
// #set par(leading: 12pt)
// #place(top+left, dx:title-position.at(0), dy:title-position.at(1), {
//   smallcaps(lower(text(size:26pt, weight: "bold", tracking: 1.5pt)[Chief executive officer]))
//   v(1em,weak: true)
// text(size:22pt)[Inhibit Coatings]
// }
// )
